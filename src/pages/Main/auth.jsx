...
const Auth = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center dark:bg-neutral-800">
      <div className="flex w-full max-w-5xl overflow-hidden rounded-xl bg-white shadow-lg dark:bg-neutral-900">
        <div className="hidden w-2/3 bg-cover bg-center lg:block">
          <img
            data-aos="fade-right"
          ...
          <div className="p-4 sm:p-7">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                ...
                <button
                  className="inline-flex items-center border-0 bg-transparent p-0 text-blue-600 hover:underline focus:outline-none dark:text-blue-500"
                  onClick={() =>
                ...
                <div className="grid gap-y-4">
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${!email || !password || (type === "signup" && (!acceptedTerms || !confirmPassword))
                        ? 'bg-neutral-400 text-neutral-200 cursor-not-allowed hover:bg-neutral-400'  // 禁用状态样式
                        : 'bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700'  // 正常状态样式
                      }
                    `}
                  >
                    {type === "signin" ? "Sign in" : "Sign up"}
